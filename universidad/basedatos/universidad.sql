...
CREATE TABLE `t_rol` (
  ...
  `rol_dashboard` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
INSERT INTO `t_rol` (`id_rol`, `rol_nombre`, `rol_dashboard`, `rol_estado`, `rol_fechahorareg`, `rol_usuarioreg`) VALUES
...
--
-- Table structure for table `bitacora_carreras`
--
...
CREATE TABLE IF NOT EXISTS `bitacora_carreras` (
  ...
  `car_observacion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `bitacora_roles`
--
...
CREATE TABLE IF NOT EXISTS `bitacora_roles` (
  ...
  `modulos` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `realizado_por` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `accion` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `bitacora_usuarios` (
  ...
  `usuario_codigo` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `usuario_nombre` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `usuario_correo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rol` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `realizado_por` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `accion` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_bitacora_usuarios_accion` (`accion`),
  KEY `idx_bitacora_usuarios_fecha` (`fecha`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `bitacora_sesiones` (
  ...
  `fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_bitacora_sesiones_accion` (`accion`),
  KEY `idx_bitacora_sesiones_fecha` (`fecha`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `t_grado` (
  ...
  `gra_nombre` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `gra_observacion` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gra_estado` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `gra_fechahorareg` datetime NOT NULL,
  `gra_usuarioreg` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE t_carrera ADD id_grado INT NOT NULL;

insert into t_grado (gra_estado,gra_fechahorareg,gra_nombre,gra_observacion,gra_usuarioreg) values ('A',now(),'BACHILLERATO',null,1);
insert into t_grado (gra_estado,gra_fechahorareg,gra_nombre,gra_observacion,gra_usuarioreg) values ('A',now(),'LICENCIATURA',null,1);
insert into t_grado (gra_estado,gra_fechahorareg,gra_nombre,gra_observacion,gra_usuarioreg) values ('A',now(),'MAESTRIA',null,1)
-- --------------------------------------------------------

-- --------------------------------------------------------
-- Schema additions from the live production database
-- --------------------------------------------------------

CREATE TABLE IF NOT EXISTS `t_periodo_planestudio` (
  `id_perplan` int NOT NULL AUTO_INCREMENT,
  `ppe_nombre` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ppe_estado` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ppe_fechahorareg` datetime NOT NULL,
  `ppe_usuarioreg` int NOT NULL,
  PRIMARY KEY (`id_perplan`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `t_recuperacion_clave` (
  ...
  KEY `ix_recuperacion_token` (`token_hash`),
  KEY `ix_recuperacion_usuario` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `t_carrera`
  ADD COLUMN IF NOT EXISTS `id_grado` int NOT NULL AFTER `car_usuarioreg`;

ALTER TABLE `t_curso`
  ADD COLUMN IF NOT EXISTS `cur_credito` int NOT NULL AFTER `cur_usuarioreg`;

ALTER TABLE `t_carrera_curso`
  ADD COLUMN IF NOT EXISTS `cac_codigo` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL AFTER `cac_usuarioreg`,
  ADD COLUMN IF NOT EXISTS `id_perplan` int NOT NULL AFTER `cac_codigo`,
  ADD COLUMN IF NOT EXISTS `cac_dependencia` int NOT NULL AFTER `id_perplan`;

ALTER TABLE `t_modulo`
  ADD COLUMN IF NOT EXISTS `mod_icono` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL AFTER `mod_usuarioreg`,
  MODIFY `mod_padre` int DEFAULT NULL;

ALTER TABLE `t_rol`
  ADD COLUMN IF NOT EXISTS `rol_dashboard` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' AFTER `rol_nombre`;


INSERT INTO `t_grado` (`gra_nombre`, `gra_observacion`, `gra_estado`, `gra_fechahorareg`, `gra_usuarioreg`)
SELECT 'BACHILLERATO', NULL, 'A', NOW(), 1
WHERE NOT EXISTS (SELECT 1 FROM `t_grado` WHERE `gra_nombre` = 'BACHILLERATO');

INSERT INTO `t_grado` (`gra_nombre`, `gra_observacion`, `gra_estado`, `gra_fechahorareg`, `gra_usuarioreg`)
SELECT 'LICENCIATURA', NULL, 'A', NOW(), 1
WHERE NOT EXISTS (SELECT 1 FROM `t_grado` WHERE `gra_nombre` = 'LICENCIATURA');

INSERT INTO `t_grado` (`gra_nombre`, `gra_observacion`, `gra_estado`, `gra_fechahorareg`, `gra_usuarioreg`)
SELECT 'MAESTRIA', NULL, 'A', NOW(), 1
WHERE NOT EXISTS (SELECT 1 FROM `t_grado` WHERE `gra_nombre` = 'MAESTRIA');

INSERT INTO `t_periodo_planestudio` (`ppe_nombre`, `ppe_estado`, `ppe_fechahorareg`, `ppe_usuarioreg`)
SELECT 'I Cuatrimestre', 'A', NOW(), 1
WHERE NOT EXISTS (SELECT 1 FROM `t_periodo_planestudio` WHERE `ppe_nombre` = 'I Cuatrimestre');

INSERT INTO `t_periodo_planestudio` (`ppe_nombre`, `ppe_estado`, `ppe_fechahorareg`, `ppe_usuarioreg`)
SELECT 'II Cuatrimestre', 'A', NOW(), 1
WHERE NOT EXISTS (SELECT 1 FROM `t_periodo_planestudio` WHERE `ppe_nombre` = 'II Cuatrimestre');

INSERT INTO `t_periodo_planestudio` (`ppe_nombre`, `ppe_estado`, `ppe_fechahorareg`, `ppe_usuarioreg`)
SELECT 'III Cuatrimestre', 'A', NOW(), 1
WHERE NOT EXISTS (SELECT 1 FROM `t_periodo_planestudio` WHERE `ppe_nombre` = 'III Cuatrimestre');
